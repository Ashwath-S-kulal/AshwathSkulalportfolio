export default function About() {
  return (
    <section id="about" className="bg-gray-800 px-6 py-12  text-white mt-5 mx-5">
      {/* Title */}
      <div className="mb-10">
      ...
      <div className="flex flex-col gap-20 md:flex-row">
        <div className="flex justify-center">
          <img
            src="https://st4.depositphotos.com/1001201/28895/i/450/depositphotos_288956182-stock-photo-abstract-internet-connection-network-background.jpg"
            alt="Ashwath"
        ...
        <div>
          <h3 className="text-2xl font-semibold mb-4">
            Engineer & Web interface Developer.
          </h3>
